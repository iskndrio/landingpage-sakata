  ...
  return (
    <section id="komunitas" className="section-container relative z-20 bg-[#f8fbff] pt-4 pb-16 md:pt-6 md:pb-24">
      <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)]">
        ...
        >
          <div className="absolute -left-6 top-12 hidden h-16 w-16 items-center justify-center rounded-full border border-blue-100 bg-white text-xs font-semibold text-slate-900 shadow-[0_14px_30px_rgba(37,99,235,0.15)] md:flex z-10">
            SA
          </div>
          <div className="absolute -right-4 top-20 hidden h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-sm font-semibold text-blue-700 md:flex z-10">
            KT
          </div>
          <div className="relative overflow-hidden rounded-[2.6rem] bg-blue-100 p-3 shadow-[0_30px_80px_rgba(37,99,235,0.2)]">
            <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[2.1rem] bg-white">
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[#0b1220]/70 to-transparent p-6 pt-20">
                <div className="flex items-center justify-between">
                  <span className="rounded-full bg-white/30 px-3 py-1 text-xs font-semibold tracking-wider text-white backdrop-blur-md">
                    SAKATA
                  </span>
