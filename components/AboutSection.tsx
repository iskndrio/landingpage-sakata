...
export default function AboutSection() {
  return (
    <section id="tentang" className="py-14 md:py-24">
      <motion.div
        initial={{ opacity: 0, y: 30 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ duration: 0.5 }}
        className="section-container rounded-[2rem] bg-blue-50 border border-blue-100 px-6 py-12 text-center sm:px-8 md:px-20 md:py-16 relative overflow-hidden"
      >
        ...
        <div className="relative z-10">
          ...
          <h2 className="mx-auto mt-5 max-w-4xl font-display text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl md:text-5xl">
